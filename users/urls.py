...
urlpatterns = [
    path('', views.dashboard_redirect, name='users_root'),
    ...
    path('role-policies/', views.role_shift_policy_list, name='role_shift_policy_list'),
    path('role-policy/update/', views.update_role_shift_policy, name='update_role_shift_policy'),
